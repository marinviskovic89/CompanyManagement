...
@Slf4j
public class PaymentMethodCardReport {

    private final InvoiceService invoiceService;
    private float sum;

    public PaymentMethodCardReport(InvoiceService invoiceService) {
    ...
    public void export(HttpServletResponse response) {
        ...
        try {
            ...
            headerParagraph.add(new Chunk("List of invoices where payment method is CARD" + "\n", font));
            ...
            invoices.forEach(i -> {
                ...
                if(i.getPaymentMethod().equals("CARD")) {
