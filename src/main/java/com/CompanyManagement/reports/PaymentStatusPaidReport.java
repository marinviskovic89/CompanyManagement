...
@Slf4j
public class PaymentStatusPaidReport {

    private final InvoiceService invoiceService;
    private float sum;


    public PaymentStatusPaidReport(InvoiceService invoiceService) {
    ...
    public void export(HttpServletResponse response) {
        ...
        try {
            ...
            headerParagraph.add(new Chunk("List of PAID invoices" + "\n", font));
            ...
            invoices.forEach(i -> {
                ...
                if(i.getPaymentStatus().equals("PAYED")) {
