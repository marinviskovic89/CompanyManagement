...
@Slf4j
public class PaymentStatusOnHoldReport {

    private final InvoiceService invoiceService;
    private float sum;


    public PaymentStatusOnHoldReport(InvoiceService invoiceService) {
    ...
    public void export(HttpServletResponse response) {
        ...
        try {
            ...
            headerParagraph.add(new Chunk("List of invoices with payment status: ON HOLD" + "\n", font));
            ...
            invoices.forEach(i -> {
                ...
                if(i.getPaymentStatus().equals("ON_HOLD")) {
