...
public class MonthlyReport {
    ...
    public MonthlyReport(InvoiceService invoiceService) {
    ...
    public void export(HttpServletResponse response) {
        ...
        try {
            ...
            headerParagraph.add(new Chunk("List of all invoices in this month" + "\n", font));
            ...
            invoices.forEach(i -> {
                LocalDate date_invoice = LocalDate.parse(i.getDateOfIssue(), formatter);
                if(date.isBefore(date_invoice)== true) {
                    ...
                    PdfPCell pdfPCell5 = new PdfPCell(new Paragraph("Payment status:" + " " + i.getPaymentStatus(), font));
